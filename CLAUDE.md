...
dotnet test  Uindosill.slnx -c Release   # 1568 tests, no weights, no display, no network
...
**Eight of those 1568 tests skip themselves.** Two are platform-specific: the Media Foundation
