...
dotnet test  Uindosill.slnx -c Release   # 821 tests, no weights, no display, no network
...
**Two of those 821 skip themselves.** One is the Media Foundation extension list, which is
