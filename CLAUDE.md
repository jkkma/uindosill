...
dotnet test  Uindosill.slnx -c Release   # 1020 tests, no weights, no display, no network
...
**Two of those 1020 tests skip themselves.** One is the Media Foundation extension list, which is
