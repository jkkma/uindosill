...
dotnet test  Uindosill.slnx -c Release   # 868 tests, no weights, no display, no network
...
**Two of those 868 skip themselves.** One is the Media Foundation extension list, which is
