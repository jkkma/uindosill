...
dotnet test  Uindosill.slnx -c Release   # 1137 tests, no weights, no display, no network
...
**Four of those 1137 tests skip themselves.** One is the Media Foundation extension list, which is
