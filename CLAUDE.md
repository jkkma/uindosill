...
dotnet test  Uindosill.slnx -c Release   # 808 tests, no weights, no display, no network
...
**Two of those 808 skip themselves.** One is the Media Foundation extension list, which is
