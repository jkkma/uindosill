...
dotnet test  Uindosill.slnx -c Release   # 1455 tests, no weights, no display, no network
...
**Seven of those 1455 tests skip themselves.** One is the Media Foundation extension list, which is
