...
dotnet test  Uindosill.slnx -c Release   # 751 tests, no weights, no display, no network
...
**Nine of those 751 skip themselves, and they are the ones that read something a clone does not
