...
dotnet test  Uindosill.slnx -c Release   # 1428 tests, no weights, no display, no network
...
**Seven of those 1428 tests skip themselves.** One is the Media Foundation extension list, which is
