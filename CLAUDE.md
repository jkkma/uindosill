...
dotnet test  Uindosill.slnx -c Release   # 1262 tests, no weights, no display, no network
...
**Five of those 1262 tests skip themselves.** One is the Media Foundation extension list, which is
