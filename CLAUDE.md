...
dotnet test  Uindosill.slnx -c Release   # 981 tests, no weights, no display, no network
...
**Two of those 981 tests skip themselves.** One is the Media Foundation extension list, which is
