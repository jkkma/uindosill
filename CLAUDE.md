...
dotnet test  Uindosill.slnx -c Release   # 1548 tests, no weights, no display, no network
...
**Eight of those 1548 tests skip themselves.** Two are platform-specific: the Media Foundation
