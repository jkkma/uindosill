...
dotnet test  Uindosill.slnx -c Release   # 859 tests, no weights, no display, no network
...
**Two of those 859 skip themselves.** One is the Media Foundation extension list, which is
