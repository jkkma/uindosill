...
dotnet test  Uindosill.slnx -c Release   # 832 tests, no weights, no display, no network
...
**Two of those 832 skip themselves.** One is the Media Foundation extension list, which is
