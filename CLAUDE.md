...
dotnet test  Uindosill.slnx -c Release   # 871 tests, no weights, no display, no network
...
**Two of those 871 skip themselves.** One is the Media Foundation extension list, which is
