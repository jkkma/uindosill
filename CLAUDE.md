...
dotnet test  Uindosill.slnx -c Release   # 1116 tests, no weights, no display, no network
...
**Four of those 1116 tests skip themselves.** One is the Media Foundation extension list, which is
