...
dotnet test  Uindosill.slnx -c Release   # 1575 tests, no weights, no display, no network
...
**Eight of those 1575 tests skip themselves.** Two are platform-specific: the Media Foundation
