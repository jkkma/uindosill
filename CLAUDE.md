...
dotnet test  Uindosill.slnx -c Release   # 1270 tests, no weights, no display, no network
...
**Five of those 1270 tests skip themselves.** One is the Media Foundation extension list, which is
