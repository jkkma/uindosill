...
dotnet test  Uindosill.slnx -c Release   # 1216 tests, no weights, no display, no network
...
**Four of those 1216 tests skip themselves.** One is the Media Foundation extension list, which is
