...
dotnet test  Uindosill.slnx -c Release   # 1515 tests, no weights, no display, no network
...
**Eight of those 1515 tests skip themselves.** Two are platform-specific: the Media Foundation
