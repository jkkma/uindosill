...
dotnet test  Uindosill.slnx -c Release   # 865 tests, no weights, no display, no network
...
**Two of those 865 skip themselves.** One is the Media Foundation extension list, which is
