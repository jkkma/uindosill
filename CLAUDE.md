...
dotnet test  Uindosill.slnx -c Release   # 817 tests, no weights, no display, no network
...
**Two of those 817 skip themselves.** One is the Media Foundation extension list, which is
