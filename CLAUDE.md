...
dotnet test  Uindosill.slnx -c Release   # 852 tests, no weights, no display, no network
...
**Two of those 852 skip themselves.** One is the Media Foundation extension list, which is
