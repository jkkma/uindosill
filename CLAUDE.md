...
dotnet test  Uindosill.slnx -c Release   # 258 tests, no weights, no display, no network
...
`scripts/lab.ps1` is one entry point for the five scripts; run it bare to list them.
