...
dotnet test  Uindosill.slnx -c Release   # 962 tests, no weights, no display, no network
...
**Two of those 949 skip themselves.** One is the Media Foundation extension list, which is
