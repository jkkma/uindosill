...
dotnet test  Uindosill.slnx -c Release   # 793 tests, no weights, no display, no network
...
**Two of those 793 skip themselves.** One is the Media Foundation extension list, which is
