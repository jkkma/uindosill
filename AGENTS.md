...
dotnet test  Uindosill.slnx -c Release   # 1747 tests, no weights, no display, no network
...
**Nine of those 1747 tests skip themselves.** Two are platform-specific: the Media Foundation
