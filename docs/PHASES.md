...
**Status:** met. 299 tests, no weights, no display, no network. One of them — the Media Foundation
extension list — is Windows-only and skips itself here, so a Linux run reports 298 passed and
1 skipped.
