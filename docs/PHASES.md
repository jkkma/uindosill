...
The human adequacy sheet has 60 Spanish rows and no ratings in it yet. `docs/UNPROVEN.md` § *Translating into English* carries the floors and everything still open.
