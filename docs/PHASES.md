...
**Status:** met. 1305 tests, no weights, no display, no network — **1299 passed and 6 skipped**, and
...
**1305 tests, no weights, no display, no network — 1299 passed and 6 skipped.** `CLAUDE.md`'s second
count said 949 and had been stale by thirty for some time, because `949 skip` does not match the
pattern `scripts/check-test-counts.py` looks for; it is reworded to `1305 tests` so the guard now
covers it.
...
**1305 tests, no weights, no display, no network — 1299 passed and 6 skipped.**
...
**1305 tests, no weights, no display, no network — 1299 passed and 6 skipped.** Two of the four
...
**1305 tests, no weights, no display, no network — 1299 passed and 6 skipped.** The C# suite does
...
**1305 tests, no weights, no display, no network — 1299 passed and 6 skipped.** Twenty-two new, and
...
page instead. **1305 tests, no weights, no display, no network — 1299 passed and 6 skipped.** The
...
assertion. **1305 tests, 1299 passed and 6 skipped, the count unchanged**: the file-writing
...
**1305 tests, no weights, no display, no network — 1299 passed and 6 skipped.** Six of the new ones
...
**1305 tests, no weights, no display, no network — 1299 passed and 6 skipped.** No test changed: the
...
**1305 tests, no weights, no display, no network — 1299 passed and 6 skipped**, up from 1144;
...
retrieval as success, and the three refusals. **1305 tests, no weights, no display, no network —
1299 passed and 6 skipped**, up from 1262; 179 CLI tests.
...
the file's SHA-256 is unchanged across a full suite that previously rewrote it. **1305 tests, no
weights, no display, no network — 1299 passed and 6 skipped.** `docs/GOTCHAS.md` gotcha 33
carries the shape.
