...
**Status:** met. 1427 tests, no weights, no display, no network — **1420 passed and 7 skipped**, and
...
**1427 tests, no weights, no display, no network — 1420 passed and 7 skipped.** `CLAUDE.md`'s second
count said 949 and had been stale by thirty for some time, because `949 skip` does not match the
pattern `scripts/check-test-counts.py` looks for; it is reworded to `1427 tests` so the guard now
covers it.
...
**1427 tests, no weights, no display, no network — 1420 passed and 7 skipped.**
...
**1427 tests, no weights, no display, no network — 1420 passed and 7 skipped.** Two of the four
...
**1427 tests, no weights, no display, no network — 1420 passed and 7 skipped.** The C# suite does
...
**1427 tests, no weights, no display, no network — 1420 passed and 7 skipped.** Twenty-two new, and
...
page instead. **1427 tests, no weights, no display, no network — 1420 passed and 7 skipped.** The
...
assertion. **1427 tests, 1420 passed and 7 skipped, the count unchanged**: the file-writing
...
**1427 tests, no weights, no display, no network — 1420 passed and 7 skipped.** Six of the new ones
...
**1427 tests, no weights, no display, no network — 1420 passed and 7 skipped.** No test changed: the
...
**1427 tests, no weights, no display, no network — 1420 passed and 7 skipped**, up from 1144;
...
retrieval as success, and the three refusals. **1427 tests, no weights, no display, no network —
1420 passed and 7 skipped**, up from 1262; 179 CLI tests.
...
the file's SHA-256 is unchanged across a full suite that previously rewrote it. **1427 tests, no
weights, no display, no network — 1420 passed and 7 skipped.** `docs/GOTCHAS.md` gotcha 33
carries the shape.
...
`docs/UNPROVEN.md`. **1427 tests, 1420 passed and 7 skipped, 0 warnings**, and the gated engine
...
**1427 tests, 1420 passed and 7 skipped, 0 warnings**, the gated engine trio green on cpu and
...
change, and the count this document quotes is the current one — **1427 tests, 1420 passed and 7
