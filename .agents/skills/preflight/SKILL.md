...
AGENTS.md's **"Building and testing"** section is the source of truth for every command here.
If this file and AGENTS.md disagree, AGENTS.md wins and this file is the one to fix. Read that
