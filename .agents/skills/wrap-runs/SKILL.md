...
AGENTS.md's **"Where output goes"** section is the source of truth for every rule this
checklist orders. If this file and AGENTS.md ever disagree, AGENTS.md wins and this file is the
...
(per-timestamp, per-machine, `wer/`, `der/`, `tidy-units/` — AGENTS.md names the common ones, and
...
- Where these bullets seem to collide, AGENTS.md's own paragraph settles it, not this file.
